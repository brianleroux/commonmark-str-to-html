...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/generation/generators/expressions.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/generation/generators/expressions.js</span></h1>
    <h2>
        
        Statements: <span class="metric">98.65% <small>(73 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">88.46% <small>(23 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(14 / 14)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">98.61% <small>(71 / 72)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">6to5/generation/generators/</a> &#187; expressions.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1714</span>
<span class="cline-any cline-yes">1714</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
exports.NewExpression = function (node, print) {
  this.push("new ");
  print(node.callee);
  <span class="missing-if-branch" title="else path not taken" >E</span>if (node.arguments.length || this.format.parentheses) {
    this.push("(");
...
var buildYieldAwait = function (keyword) {
  return function (node, print) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (node.argument) {
      this.space();
      print(node.argument);
    }
  };
...
&nbsp;
  if (node.computed) {
    ...
    // 5..toFixed(2);
    <span class="missing-if-branch" title="if path not taken" >I</span>if (t.isLiteral(node.object) &amp;&amp; util.isInteger(node.object.value)) {
