...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/default-parameters.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/default-parameters.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/</a> &#187; default-parameters.js</div>
</div>
<div class="body">
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (scope.has(node.name)) {
          closure = true;
        }
      };
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (has &amp;&amp; !_.contains(node.params, has)) {
<span class="cstat-no" title="statement not covered" >      closure = true;</span>
    }
  });
&nbsp;
  var body = [];
