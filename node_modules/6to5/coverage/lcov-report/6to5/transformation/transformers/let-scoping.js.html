...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/let-scoping.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/let-scoping.js</span></h1>
    <h2>
        
        Statements: <span class="metric">96.31% <small>(209 / 217)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">90.98% <small>(111 / 122)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(32 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">96.97% <small>(192 / 198)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/</a> &#187; let-scoping.js</div>
</div>
<div class="body">
...
473
474
475</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1630</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">596</span>
<span class="cline-any cline-yes">968</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var traverse = require("../../traverse");
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (hasYield) {
<span class="cstat-no" title="statement not covered" >    fn.generator = true;</span>
<span class="cstat-no" title="statement not covered" >    call = t.yieldExpression(call, true);</span>
  }
&nbsp;
  this.build(ret, call);
};
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (forParent &amp;&amp; node &amp;&amp; !node.label) {
...
LetScoping.prototype.hoistVarDeclarations = function () {
  var self = this;
  traverse(this.block, function (node) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (t.isForStatement(node)) {
<span class="cstat-no" title="statement not covered" >      if (isVar(node.init)) {</span>
<span class="cstat-no" title="statement not covered" >        node.init = t.sequenceExpression(self.pushDeclar(node.init));</span>
      }
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (t.isFor(node)) {
<span class="cstat-no" title="statement not covered" >      if (isVar(node.left)) {</span>
<span class="cstat-no" title="statement not covered" >        node.left = node.left.declarations[0].id;</span>
      }
    } else if (isVar(node)) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!t.isReferenced(node, parent)) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
...
&nbsp;
  _.each(node.declarations, function (declar) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!declar.init) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (has.hasReturn) body.push(retCheck);
  }
};
&nbsp;</pre></td></tr>
</table></pre>
