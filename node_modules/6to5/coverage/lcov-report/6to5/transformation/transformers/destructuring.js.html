...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/destructuring.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/destructuring.js</span></h1>
    <h2>
        
        Statements: <span class="metric">94.17% <small>(113 / 120)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">86.21% <small>(50 / 58)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">93.75% <small>(15 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">93.58% <small>(102 / 109)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/</a> &#187; destructuring.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!t.isProgram(parent) &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!t.isBlockStatement(parent))</span> {
<span class="cstat-no" title="statement not covered" >    var declar;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _.each(nodes, <span class="fstat-no" title="function not covered" >function (node) {</span></span>
<span class="cstat-no" title="statement not covered" >      declar = declar || t.variableDeclaration(node.kind, []);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!t.isVariableDeclaration(node) &amp;&amp; declar.kind !== node.kind) {</span>
<span class="cstat-no" title="statement not covered" >        throw file.errorWithNode(node, "Cannot use this node within the current parent");</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      declar.declarations = declar.declarations.concat(node.declarations);</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return declar;</span>
  }
&nbsp;
  return nodes;
};
