...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/generators/hoist.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/generators/hoist.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/generators/</a> &#187; hoist.js</div>
</div>
<div class="body">
...
&nbsp;
    visitForStatement: function (path) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isVariableDeclaration(init)) {
...
&nbsp;
    visitForInStatement: function (path) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isVariableDeclaration(left)) {
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isBlockStatement(path.parent.node)) {
...
<span class="cstat-no" title="statement not covered" >        path.replace(assignment);</span>
      }
&nbsp;
...
&nbsp;
  ...
  funPath.get("params").each(function (paramPath) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isIdentifier(param)) {
...
&nbsp;
  Object.keys(vars).forEach(function (name) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.has(paramNames, name)) {
