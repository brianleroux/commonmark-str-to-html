...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/generators/emit/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/generators/emit/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">89.05% <small>(187 / 210)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">75.89% <small>(85 / 112)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">90% <small>(27 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">89% <small>(186 / 209)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/generators/emit/</a> &#187; index.js</div>
</div>
<div class="body">
...
610
611
612</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">1106</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
Emitter.prototype.mark = function (loc) {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (loc.value === -1) {
    loc.value = index;
  } else {
    // Locations can be marked redundantly, but their values cannot change
    // once set the first time.
<span class="cstat-no" title="statement not covered" >    assert.strictEqual(loc.value, index);</span>
  }
...
Emitter.prototype.isVolatileContextProperty = function (expr) {
  if (t.isMemberExpression(expr)) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (expr.computed) {
...
Emitter.prototype.stop = <span class="fstat-no" title="function not covered" >function (rval) {</span>
<span class="cstat-no" title="statement not covered" >  if (rval) {</span>
<span class="cstat-no" title="statement not covered" >    this.setReturnValue(rval);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.jump(this.finalLoc);</span>
};
&nbsp;
Emitter.prototype.setReturnValue = <span class="fstat-no" title="function not covered" >function (valuePath) {</span>
<span class="cstat-no" title="statement not covered" >  t.assertExpression(valuePath.value);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.emitAssign(</span>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (assignee) {
    this.emitAssign(assignee, catchCall);
  } else {
<span class="cstat-no" title="statement not covered" >    this.emit(catchCall);</span>
  }
};
&nbsp;
...
Emitter.prototype.getContextFunction = function (id) {
  var node = t.functionExpression(
    id || <span class="branch-1 cbranch-no" title="branch not covered" >null,</span>
    [this.contextId],
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isExpression(node))
    return self.explodeExpression(path, ignoreResult);
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (t.isDeclaration(node))</span>
<span class="cstat-no" title="statement not covered" >    throw getDeclError(node);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  switch (node.type) {</span>
  case "Program":
<span class="cstat-no" title="statement not covered" >    return path.get("body").map(self.explodeStatement, self);</span>
&nbsp;
...
&nbsp;
  ...
  case "SwitchCase":
  case "CatchClause":
<span class="cstat-no" title="statement not covered" >    throw new Error(node.type + " nodes should be handled by their parents");</span>
&nbsp;
  default:
<span class="cstat-no" title="statement not covered" >    throw new Error("unknown Node of type " + JSON.stringify(node.type));</span>
  }
};
&nbsp;
<span class="fstat-no" title="function not covered" >function getDeclError(node) {</span>
...
<span class="cstat-no" title="statement not covered" >    throw new Error("unknown Statement of type " + JSON.stringify(stmt.type));</span>
  }
};
&nbsp;
Emitter.prototype.emitAbruptCompletion = function (record) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!isValidCompletion(record)) {
<span class="cstat-no" title="statement not covered" >    assert.ok(</span>
      false,
...
&nbsp;
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (record.type === "return" || <span class="branch-1 cbranch-no" title="branch not covered" >record.type === "throw")</span> {
    if (record.value) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (type === "normal") {
<span class="cstat-no" title="statement not covered" >    return !_.has(record, "target");</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (type === "return" || <span class="branch-1 cbranch-no" title="branch not covered" >type === "throw")</span> {
...
Emitter.prototype.updateContextPrevLoc = function (loc) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (loc) {
    t.assertLiteral(loc);
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (loc.value === -1) {
      // If an uninitialized location literal was passed in, set its value
      // to the current this.listing.length.
<span class="cstat-no" title="statement not covered" >      loc.value = this.listing.length;</span>
    } else {
...
<span class="cstat-no" title="statement not covered" >    loc = this.getUnmarkedCurrentLoc();</span>
  }
&nbsp;
...
&nbsp;
    assert.ok(
      !ignoreChildResult || <span class="branch-1 cbranch-no" title="branch not covered" >!tempVar,</span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (ignoreChildResult) {
...
<span class="cstat-no" title="statement not covered" >    throw new Error("unknown Expression of type " + JSON.stringify(expr.type));</span>
  }
};
&nbsp;</pre></td></tr>
</table></pre>
