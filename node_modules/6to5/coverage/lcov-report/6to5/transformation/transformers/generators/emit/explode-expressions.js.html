...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/generators/emit/explode-expressions.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/generators/emit/explode-expressions.js</span></h1>
    <h2>
        
        Statements: <span class="metric">82.5% <small>(66 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">68.18% <small>(15 / 22)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">84.21% <small>(16 / 19)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">82.5% <small>(66 / 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/generators/emit/</a> &#187; explode-expressions.js</div>
</div>
<div class="body">
...
exports.MemberExpression = function (expr, path, explodeViaTempVar, finish) {
  return finish(t.memberExpression(
    ...
    expr.computed ? <span class="branch-0 cbranch-no" title="branch not covered" >explodeViaTempVar(null, path.get("property")) </span>: expr.property,
    expr.computed
  ));
};
&nbsp;
...
&nbsp;
exports.LogicalExpression = <span class="fstat-no" title="function not covered" >function (expr, path, explodeViaTempVar, finish, ignoreResult) {</span>
<span class="cstat-no" title="statement not covered" >  var after = loc();</span>
...
<span class="cstat-no" title="statement not covered" >    result = this.makeTempVar();</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  var left = explodeViaTempVar(result, path.get("left"));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (expr.operator === "&amp;&amp;") {</span>
<span class="cstat-no" title="statement not covered" >    this.jumpIfNot(left, after);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    assert.strictEqual(expr.operator, "||");</span>
<span class="cstat-no" title="statement not covered" >    this.jumpIf(left, after);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  explodeViaTempVar(result, path.get("right"), ignoreResult);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.mark(after);</span>
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!ignoreResult) {
...
&nbsp;
exports.UnaryExpression = <span class="fstat-no" title="function not covered" >function (expr, path, explodeViaTempVar, finish) {</span>
<span class="cstat-no" title="statement not covered" >  return finish(t.unaryExpression(</span>
    expr.operator,
...
&nbsp;
exports.UpdateExpression = <span class="fstat-no" title="function not covered" >function (expr, path, explodeViaTempVar, finish) {</span>
<span class="cstat-no" title="statement not covered" >  return finish(t.updateExpression(</span>
    expr.operator,
    this.explodeExpression(path.get("argument")),
    expr.prefix
  ));
...
&nbsp;
  ...
  this.emit(t.returnStatement(arg || <span class="branch-1 cbranch-no" title="branch not covered" >null)</span>);
  this.mark(after);
&nbsp;
