...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/generators/emit/explode-statements.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/generators/emit/explode-statements.js</span></h1>
    <h2>
        
        Statements: <span class="metric">92.2% <small>(130 / 141)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">80.95% <small>(34 / 42)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">91.3% <small>(21 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">92.2% <small>(130 / 141)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/generators/emit/</a> &#187; explode-statements.js</div>
</div>
<div class="body">
...
333
334
335</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
exports.DoWhileStatement = <span class="fstat-no" title="function not covered" >function (path, stmt, labelId) {</span>
<span class="cstat-no" title="statement not covered" >  var first = loc();</span>
<span class="cstat-no" title="statement not covered" >  var test = loc();</span>
<span class="cstat-no" title="statement not covered" >  var after = loc();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.mark(first);</span>
<span class="cstat-no" title="statement not covered" >  this.leapManager.withEntry(</span>
    new leap.LoopEntry(after, test, labelId),
<span class="fstat-no" title="function not covered" >    function () {</span> <span class="cstat-no" title="statement not covered" >this.explode(path.get("body")); </span>}
  );
<span class="cstat-no" title="statement not covered" >  this.mark(test);</span>
<span class="cstat-no" title="statement not covered" >  this.jumpIf(this.explodeExpression(path.get("test")), first);</span>
...
exports.ForStatement = function (path, stmt, labelId) {
  ...
  var after = loc();
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (stmt.init) {
...
&nbsp;
  this.mark(head);
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (stmt.test) {
    this.jumpIfNot(this.explodeExpression(path.get("test")), after);
  } else {
...
&nbsp;
  ...
  var cases = stmt.cases || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
  for (var i = cases.length - 1; i &gt;= 0; --i) {
    var c = cases[i];
    t.assertSwitchCase(c);
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (c.test) {
...
<span class="cstat-no" title="statement not covered" >      caseLocs[i] = defaultLoc;</span>
    }
  }
&nbsp;
...
&nbsp;
  this.mark(after);
  <span class="missing-if-branch" title="else path not taken" >E</span>if (defaultLoc.value === -1) {
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!handler &amp;&amp; stmt.handlers) {
<span class="cstat-no" title="statement not covered" >    handler = stmt.handlers[0] || null;</span>
  }
&nbsp;
