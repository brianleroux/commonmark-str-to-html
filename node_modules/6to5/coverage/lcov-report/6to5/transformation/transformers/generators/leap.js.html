...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformation/transformers/generators/leap.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformation/transformers/generators/leap.js</span></h1>
    <h2>
        
        Statements: <span class="metric">98.85% <small>(86 / 87)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">6to5/transformation/transformers/generators/</a> &#187; leap.js</div>
</div>
<div class="body">
...
LeapManager.prototype._findLeapLocation = function (property, label) {
  for (var i = this.entryStack.length - 1; i &gt;= 0; --i) {
    ...
    if (loc) {
      if (label) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (entry.label &amp;&amp;
