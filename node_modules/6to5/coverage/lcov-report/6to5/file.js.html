...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/file.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/file.js</span></h1>
    <h2>
        
        Statements: <span class="metric">96.33% <small>(105 / 109)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">83.33% <small>(30 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">100% <small>(14 / 14)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">97.17% <small>(103 / 106)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">6to5/</a> &#187; file.js</div>
</div>
<div class="body">
...
210
211
212</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">319</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">319</span>
<span class="cline-any cline-yes">319</span>
<span class="cline-any cline-yes">319</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">317</span>
<span class="cline-any cline-yes">8114</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-yes">282</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">module.exports = File;
&nbsp;
var SHEBANG_REGEX = /^\#\!.*/;
&nbsp;
...
File.prototype.getModuleFormatter = function (type) {
  var ModuleFormatter = _.isFunction(type) ? <span class="branch-0 cbranch-no" title="branch not covered" >type </span>: transform.moduleFormatters[type];
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!ModuleFormatter) {
<span class="cstat-no" title="statement not covered" >    var loc = util.resolve(type);</span>
<span class="cstat-no" title="statement not covered" >    if (loc) <span class="cstat-no" title="statement not covered" >ModuleFormatter = require(loc);</span></span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!ModuleFormatter) {
<span class="cstat-no" title="statement not covered" >    throw new ReferenceError("unknown module formatter type " + type);</span>
  }
&nbsp;
...
File.prototype.parse = function (code) {
  code = (code || <span class="branch-1 cbranch-no" title="branch not covered" >"")</span> + "";
&nbsp;
  var self = this;
&nbsp;
  this.code = code;
