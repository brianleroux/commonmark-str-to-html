...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/types/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/types/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">95.68% <small>(133 / 139)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">94.12% <small>(80 / 85)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">96.43% <small>(27 / 28)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">95.42% <small>(125 / 131)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">6to5/types/</a> &#187; index.js</div>
</div>
<div class="body">
...
268
269
270</td><td class="line-coverage"><span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">85</span>
<span class="cline-any cline-yes">3854</span>
<span class="cline-any cline-yes">3854</span>
...
<span class="cline-any cline-yes">453170</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">74</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">10526</span>
<span class="cline-any cline-yes">10526</span>
<span class="cline-any cline-yes">10526</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">10</span>
<span class="cline-any cline-yes">681138</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">10</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2050</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">98311</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">98311</span>
<span class="cline-any cline-yes">3593</span>
<span class="cline-any cline-yes">825</span>
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7571</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7271</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6732</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">6732</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">6732</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1840</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">5837</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5837</span>
<span class="cline-any cline-yes">5837</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">5837</span>
<span class="cline-any cline-yes">7911</span>
<span class="cline-any cline-yes">7911</span>
<span class="cline-any cline-yes">7910</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7886</span>
<span class="cline-any cline-yes">7886</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7886</span>
<span class="cline-any cline-yes">5776</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">3871</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
...
var addAssert = function (type, is) {
  t["assert" + type] = function (node, opts) {
    opts = opts || {};
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!is(node, opts)) {
<span class="cstat-no" title="statement not covered" >      throw new Error("Expected type " + JSON.stringify(type) + " with option " + JSON.stringify(opts));</span>
    }
  };
};
&nbsp;
...
&nbsp;
  if (!newType) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ignore) {
      return false;
    } else {
<span class="cstat-no" title="statement not covered" >      throw new Error("cannot turn " + node.type + " to a statement");</span>
    }
  }
&nbsp;
  node.type = newType;
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!_.isArray(node)) {
    if (!t.isStatement(node)) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (t.isFunction(parent)) {
        node = t.returnStatement(node);
      } else {
<span class="cstat-no" title="statement not covered" >        node = t.expressionStatement(node);</span>
      }
    }
&nbsp;
    node = [node];
...
&nbsp;
    if (t.isIdentifier(id)) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (id[nodeKey]) search.push(id[nodeKey]);
    } else if (arrKey) {
...
&nbsp;
t.removeComments = <span class="fstat-no" title="function not covered" >function (child) {</span>
<span class="cstat-no" title="statement not covered" >  delete child.leadingComments;</span>
<span class="cstat-no" title="statement not covered" >  delete child.trailingComments;</span>
